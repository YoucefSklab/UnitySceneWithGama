...
namespace ummisco.gama.unity.topics
{
	public class MoveTopic : Topic
	{
		...
		public void ProcessTopic (object obj)
		{
			...
			Vector3 movement = topicMessage.position.getVector3();
		...
		{
            Debug.Log("Topic Move to Position ---> " + movement + "   with speed " + topicMessage.speed + " and smoothMove = "+ topicMessage.smoothMove);
