			...
			foreach (Component c in cs) {
				...
				if (propertyInfo != null) {
					...
					if (propertyInfo.PropertyType.Equals (typeof(Vector3))) {
                       ...
                       // Vector3 vect = topicMessage.GetValueAsVector3(); //ConvertType.vector3FromXmlNode (node, MqttSetting.GAMA_POINT);
                        Vector3 vect = topicMessage.GetValueAsGamaPoint().getVector3(); //ConvertType.vector3FromXmlNode (node, MqttSetting.GAMA_POINT);
						...
						try{
                            ...
                            object val = topicMessage.GetValueAsString();
