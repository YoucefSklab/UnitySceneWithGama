...
namespace ummisco.gama.unity.littosim
{
    public static class IUILittoSim
    {
        ...
        public static string ACTION_LIST_RECAP_PANEL = "Action_List_Recap_Panel";


        public static string MAIN_CANVAS = "Main_Canvas";
        ...
        public static string BUDGET_ACTION_LIST = "Budget_Action_List";
        public static string BUDGET_RESTANT = "Budget_Restant";
        public static string BUDGET_INITIAL = "Budget_Initial";


        public static string ACTION_FERMER_BOTTON = "Action_Fermer_Button";
        ...
        public static string ACTION_RECAP_CYCLE_ICON = "Action_Recap_Cycle_Icon";
        public static string ACTION_RECAP_CYCLE_PLUS_NBR = "Action_Recap_Cycle_Plus_Nbr";

        public static string ACTION_RECAP_ROUND = "Action_Recap_Round";

        public static string ACTION_CYCLE_VALUE = "Action_Cycle_Value";
